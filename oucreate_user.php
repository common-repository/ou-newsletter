...
if (!wp_verify_nonce($ounewsletcode, 'gtruhcfuf'))
{
    wp_die();
}


$onnewslettera_add_user_firstname =  sanitize_text_field($_POST['onnewslettera_add_user_firstname1']);
$onnewslettera_add_user_lastname =  sanitize_text_field($_POST['onnewslettera_add_user_lastname1']);
$onnewslettera_add_email = sanitize_email($_POST['onnewslettera_add_user_email1']);
